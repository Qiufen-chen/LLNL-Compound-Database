...
select * from chembl_23.activities where standard_type = 'LogD' and standard_units is null;
...
where a.standard_type = 'LogD' and a.standard_units is null and e.hba <= 10 and e.hbd <= 5 and  e.mw_freebase  between 180 and 500
and  c.chembl_id is not null
and a.standard_value is not null
and b.canonical_smiles is not null
into outfile '/tmp/LogD_null.csv'
